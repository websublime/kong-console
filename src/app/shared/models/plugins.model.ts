...
export const PLUGINSDATA = [
  { id: 'ssl', img: 'dynamic-ssl.png', title: 'Dynamic SSL', info: 'Add an SS certificate for an underlying service.', api: true, consumer: true },
  ...
  { id: 'cors', img: 'cors.png', title: 'CORS', info: 'Allow developers to make requests from the browser.', api: true, consumer: true },
